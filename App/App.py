# Developed by Muhammad Qasim Zahoor [https://github.com/qasimzahoor825]    Made with Streamlit
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://github.com/qasimzahoor825" style="text-decoration: none; color: #021659;">Muhammad Qasim Zahoor</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://github.com/qasimzahoor825" style="text-decoration: none; color: grey;">Muhammad Qasim Zahoor</a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Muhammad Qasim Zahoor ! Total %d " % values + " User's Have Used Our Tool : )")                
